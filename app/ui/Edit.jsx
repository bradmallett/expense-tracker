...
export default function Edit({ transaction }) {
    ...
    return (
      <>
        ...
        {isOpen && (
            <div className='z-50 editTransaction w-full min-h-screen bg-slate-900 border-2 absolute top-0 left-0  border-orange-600 p-1 md:w-1/2 md:h-auto md:min-h-0 md:max-w-[660px] md:fixed md:top-1/4 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/4'>
