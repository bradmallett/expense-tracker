...
export default function DeleteTransaction({ transData }) {
    ...
    return (
        ...
        {isOpen && (
            <div className="z-50 deleteTransaction bg-slate-900 min-w-72 border-2 border-orange-600 p-1 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" >
